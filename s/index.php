...
if (!empty($_POST)) {
    if (isset($_POST["add_favourites"])) {
        ...
        if ($db->query("INSERT INTO favourites SET user_id='$suid', product_id='$pid'")) {
            echo "<script>
    ...
    if (isset($_POST["del_favourites"])) {
        $suid = $_SESSION["user"]["id"];
        $pid = $_POST["pid"];

        if ($db->query("DELETE FROM favourites WHERE user_id='$suid' AND product_id='$pid'")) {
            echo "<script>
...
<body>
    ...
    <main>
        <div class="dl">
            <section class="prd__new">
                <h2 class="df ai jcc"><img src="image/new.svg" alt="NEW" height="48" width="48">Новинки</h2>
            ...
            <section class="prd__sale">
                ...
                <div class="products df jc">
                    <?php foreach ($withDiscount as $product) : ?>
                        <div class="card">
